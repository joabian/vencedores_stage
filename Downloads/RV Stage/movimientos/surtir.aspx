    ...
    <div style="text-align:center; margin-left:auto; margin-right:auto; width:1000px; margin-top:20px;">
        <div id="Printdiv">
            <div style="text-align:center">
                ...
                <asp:Label ID="lbl_order" runat="server" Font-Size="Large"></asp:Label> <br />
                ...
                <asp:Label ID="Label3" runat="server" Font-Size="Large">Paqueteria: </asp:Label>
